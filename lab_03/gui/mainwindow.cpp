...
void MainWindow::on_moveRigthBtn_clicked()
{
    try
    {
        checkCamExist();
...
void MainWindow::on_rotateUpBtn_clicked()
{
    try
    {
        checkCamExist();
    ...
    RotateCamera rotate_cmd(camera, 0, 10 * M_PI / 180, 0);
    _facade->execute(rotate_cmd);

    updateScene();
}

void MainWindow::on_rotateDownBtn_clicked()
{
    try
    {
        checkCamExist();
...
void MainWindow::on_rotateRigthBtn_clicked()
{
    try
    {
        checkCamExist();
    ...
    RotateCamera rotate_cmd(camera, -10 * M_PI / 180, 0, 0);
    _facade->execute(rotate_cmd);
